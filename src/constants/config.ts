...
export const APP_NAME =
  process.env.NUXT_PUBLIC_APP_NAME || 'refnote'

/**
 * 1ページあたりの記事表示件数
 */
export const BLOG_SHOW_COUNT =
  Number(process.env.NUXT_PUBLIC_BLOG_SHOW_COUNT) || 10
...
export const METADATA_DESCRIPTION = {
  ...
  TERM:
    'refnote（当サイト）は、ユーザーの個人情報を適切に取り扱うため、個人情報保護法その他関連法令を遵守し、以下のプライバシーポリシーを定めます。',
}
...
export const METADATA_KEYWORD = {
  BASIC:
    'refnote, エンジニア, プログラミング, Web開発, Nuxt, Vue, TypeScript, 個人開発',
}
